...
public class ImManager extends ImReqManager {
    ...
    public void loginImUser(final String userAccount,final String pwd, final OnImLoginListener listener){
        JMessageClient.login(userAccount,pwd, new BasicCallback() {
            @Override
            public void gotResult(int i, String s) {
                if (i == 0){
                    ...
                    registerImUser(userAccount,pwd,listener);
                }
            }
        });
    }

    private void registerImUser(final String userAccount, final String password, final OnImLoginListener listener){
        JMessageClient.register(userAccount,password, new BasicCallback() {
            @Override
            public void gotResult(int i, String s) {
                if (i == 0){
                    isLogin = true;
                    loginImUser(userAccount,password,listener);
                }
            }
        });
    }
...
//                JMessageClient.enterSingleConversation(userName);
    ...
    public void handleMessage(Message message){
        ...
        MyClient.getMyClient().getImManager().handleBroadcastMsg(UrlConstantV2.VALUE.IM_LEFT_1,content);
    }
     ...
     * @param content
     */
    public void sendMessage(final String content, final OnImSendMsgListener listener){
        ...
        message.setOnSendCompleteCallback(new BasicCallback() {
            ...
            public void gotResult(int i, String s) {
                ...
                if (i == 0){
                    handleBroadcastMsg(UrlConstantV2.VALUE.IM_RIGHT_1,content);
                    if (listener != null){
                        listener.onImSendMsgListener(content);
                    }
                }
            }
        });
    ...
    public void handleBroadcastMsg(ImModel model){
        Intent intent = new Intent(UrlConstantV2.RECEIVER.ACTION_IM);
        Bundle bundle = new Bundle();
        bundle.putSerializable(UrlConstantV2.BUNDLE.IM_MODEL,model);
        intent.putExtras(bundle);
        mContext.sendBroadcast(intent);
        switch (model.getContent()){
            case "1":{
                String content1 = "同学你好，我是华南理工大学招生咨询小助手，请问有什么可以帮您的吗？";
                MyClient.getMyClient().getImManager().handleBroadcastMsg(UrlConstantV2.VALUE.IM_LEFT_2,content1);
                break;
            }
            case "2":{
                String content2 = "";
                MyClient.getMyClient().getImManager().handleBroadcastMsg(UrlConstantV2.VALUE.IM_LEFT_3,content2);
                break;
            }
            case "3":{
                String content3 = "华南理工大学为四人间。";
                MyClient.getMyClient().getImManager().handleBroadcastMsg(UrlConstantV2.VALUE.IM_LEFT_4,content3);
                break;
            }
            case "4":{
                ...
                MyClient.getMyClient().getImManager().handleBroadcastMsg(UrlConstantV2.VALUE.IM_LEFT_5,content4);
                break;
            }
            case "5":{
                String content5 = "";
                MyClient.getMyClient().getImManager().handleBroadcastMsg(UrlConstantV2.VALUE.IM_LEFT_6,content5);
                break;
            }
            case "6":{
                String content6 = "";
                MyClient.getMyClient().getImManager().handleBroadcastMsg(UrlConstantV2.VALUE.IM_LEFT_7,content6);
                break;
            }
            case "7":{
                String content7 = "";
                MyClient.getMyClient().getImManager().handleBroadcastMsg(UrlConstantV2.VALUE.IM_LEFT_8,content7);
                break;
            }
            case "8":{
                String content8 = "";
                MyClient.getMyClient().getImManager().handleBroadcastMsg(UrlConstantV2.VALUE.IM_LEFT_9,content8);
                break;
            }
            case "9":{
                ...
                model9.setType(UrlConstantV2.VALUE.IM_LEFT_10);
                MyClient.getMyClient().getImManager().handleBroadcastMsg(model9);
                break;
            }
            case "11":{
                ImModel imModel11 = new ImModel();
                imModel11.setType(UrlConstantV2.VALUE.IM_PUSH_MSG);
            ...
            case "12":{
                ...
                imModel12.setType(UrlConstantV2.VALUE.IM_PUSH_MSG);
            ...
            case "13":{
                ...
                imModel13.setType(UrlConstantV2.VALUE.IM_PUSH_MSG);
            ...
            case "14":{
                String content11 = "";
                MyClient.getMyClient().getImManager().handleBroadcastMsg(UrlConstantV2.VALUE.IM_LEFT_11,content11);
            }
        }
    }
